<?php
namespace Custom\TwitterPost\Block;
use \DateTime;
class TwitterPost extends \Magento\Framework\View\Element\Template
{
    /**
     * @var string
     */
    ...
    public function getTwitterMentioned(){
        ...
        $tweetCollection = '';
        foreach($tweets as $i=>$t){
            $tweetCollection[$i]['custom_url']='';
            $customUrl = 'https://twitter.com/';
            if(isset($t->text)){
                $tweetCollection[$i]['text'] = $t->text;
            }
            ...
            if(isset($t->user)){
                if(isset($t->user->screen_name)){
                    $customUrl = $customUrl.$t->user->screen_name.'/status/';
                }
                if(isset($t->id_str)){
                    $customUrl = $customUrl.$t->id_str;
                    $tweetCollection[$i]['custom_url'] = $customUrl;
                }
            }
